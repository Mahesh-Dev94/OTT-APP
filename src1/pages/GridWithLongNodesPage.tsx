...
import { MutableRefObject, RefObject, forwardRef, useRef } from 'react';
      ...
      <CenteringView>
        <GridContainer>
          ...
          >
            ...
            <Spacer gap="$6" />
            <ProgramListWithTitle title="Imperative focus on virtualized list" listRef={listRef as MutableRefObject<SpatialNavigationVirtualizedListRef>} data={[]} />
...
const ButtonRow = ({
  ...
  firstItemRef: RefObject<SpatialNavigationNodeRef>;
  lastItemRef: RefObject<SpatialNavigationNodeRef>;
}) => {
  return (
    <SpatialNavigationNode orientation="horizontal">
      <ListContainer>
